...
export const PatientDetails: React.FC<PatientDetailsProps> = ({ patient, onBack, onUpdate }) => {
  ...
  const startTest = (testId: string) => {
    ...
    if (testId === 'fried') {
      ...
      alert('Este teste será implementado nas próximas etapas.');
    }
  };
  ...
  const handleSaveMeem = () => {
    if (!educationLevel) {
      alert("Por favor, selecione a escolaridade antes de finalizar.");
      return;
    }
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <Modal
        ...
        title={
          activeTestId === 'tug' ? "Protocolo TUG" : 
          activeTestId === 'fried' ? "Protocolo de Fragilidade (Fried)" :
          activeTestId === 'sit_stand_30' ? "Protocolo Sentar e Levantar (30s)" : 
          activeTestId === 'arm_curl' ? "Protocolo Flexão de Cotovelo (30s)" :
          activeTestId === 'sit_reach' ? "Protocolo Sentar e Alcançar" :
          activeTestId === 'gds15' ? "Protocolo GDS-15" :
          activeTestId === 'meem_cognitive' ? "Protocolo MEEM" :
          activeTestId === 'berg_balance' ? "Protocolo de Equilíbrio de Berg" :
          "Protocolo"
        }
      >
        <div className="space-y-6 text-gray-700">
          {activeTestId === 'fried' && (
            <>
               <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                 <h4 className="font-bold text-blue-900">Referência Científica</h4>
                 <p className="text-sm text-blue-800">Baseado em Fried et al. (2001) e adaptado conforme E-book "Avaliação Funcional do Idoso".</p>
               </div>
               <ul className="list-disc list-inside space-y-2">
                 <li><strong>Perda de peso não intencional:</strong> &gt;4.5kg ou 5% no último ano.</li>
                 <li><strong>Fadiga/Exaustão:</strong> Autorrelato de que "tudo é um sacrifício" ou "não consegue ir adiante" (CES-D).</li>
                 <li><strong>Baixo nível de atividade física:</strong> Sedentário (IPAQ reduzido).</li>
                 <li><strong>Lentidão na marcha:</strong> Tempo aumentado no teste de 4.6m (ajustado por altura/sexo).</li>
                 <li><strong>Fraqueza muscular:</strong> Força de preensão manual reduzida (dinamometria ajustada por IMC).</li>
               </ul>
            </>
          )}
          ...
          {activeTestId === 'tug' && (
            <>
               <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                 <h4 className="font-bold text-blue-900">Timed Up and Go (TUG)</h4>
                 <p className="text-sm text-blue-800">Avaliação da mobilidade funcional e risco de quedas.</p>
               </div>
               <div className="space-y-2">
                 <h5 className="font-bold text-gray-900">Instruções:</h5>
                 <ol className="list-decimal list-inside space-y-1">
                   <li>Paciente sentado com as costas apoiadas.</li>
                   <li>Ao comando "Vá", levantar-se (pode usar os braços).</li>
                   <li>Caminhar até a marca de 3 metros.</li>
                   <li>Girar 180 graus.</li>
                   <li>Retornar à cadeira e sentar-se.</li>
                 </ol>
                 <p className="text-sm mt-2 font-bold">Pontos de Corte:</p>
                 <ul className="list-disc list-inside text-sm">
                   <li>&lt; 10s: Baixo Risco (Independente)</li>
                   <li>10-20s: Risco Moderado (Frágil)</li>
                   <li>&gt; 20s: Alto Risco (Dependente)</li>
                 </ul>
               </div>
            </>
          )}

          {activeTestId === 'sit_stand_30' && (
            <>
               <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                 <h4 className="font-bold text-blue-900">Sentar e Levantar (30 segundos)</h4>
                 <p className="text-sm text-blue-800">Força de membros inferiores (Rikli & Jones).</p>
               </div>
               <div className="space-y-2">
                 <h5 className="font-bold text-gray-900">Instruções:</h5>
                 <ul className="list-disc list-inside space-y-1">
                   <li>Sentado no meio da cadeira, costas retas.</li>
                   <li>Pés apoiados no chão.</li>
                   <li>Braços cruzados sobre o peito.</li>
                   <li>Ao sinal, levantar-se totalmente e sentar-se totalmente.</li>
                   <li>Repetir o máximo de vezes possível em 30 segundos.</li>
                 </ul>
               </div>
            </>
          )}

          {activeTestId === 'arm_curl' && (
            <>
               <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                 <h4 className="font-bold text-blue-900">Flexão de Cotovelo (30 segundos)</h4>
                 <p className="text-sm text-blue-800">Força de membros superiores (Rikli & Jones).</p>
               </div>
               <div className="space-y-2">
                 <h5 className="font-bold text-gray-900">Instruções:</h5>
                 <ul className="list-disc list-inside space-y-1">
                   <li>Sentado, costas apoiadas.</li>
                   <li>Segurar halter com a mão dominante (Homens: 4kg / Mulheres: 2kg).</li>
                   <li>Realizar flexão completa (palma para cima) e extensão completa.</li>
                   <li>Repetir o máximo de vezes possível em 30 segundos.</li>
                 </ul>
               </div>
            </>
          ...
          {activeTestId === 'sit_reach' && (
            <>
               <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                 <h4 className="font-bold text-blue-900">Sentar e Alcançar (Cadeira)</h4>
                 <p className="text-sm text-blue-800">Flexibilidade de cadeia posterior (Rikli & Jones).</p>
               </div>
               <div className="space-y-2">
                 <h5 className="font-bold text-gray-900">Instruções:</h5>
                 <ul className="list-disc list-inside space-y-1">
                   <li>Sentar na ponta da cadeira.</li>
                   <li>Estender uma perna com calcanhar no chão e pé fletido (90º).</li>
                   <li>Outra perna flexionada com pé apoiado.</li>
                   <li>Mãos sobrepostas, expirar e alcançar em direção à ponta do pé.</li>
                   <li>Manter por 2 segundos.</li>
                   <li><strong>Medida:</strong> Ponta do pé é o ponto zero. Faltar é negativo (-), ultrapassar é positivo (+).</li>
                 </ul>
               </div>
            </>
          )}
          ...
          {activeTestId === 'gds15' && (
            <>
               <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                 <h4 className="font-bold text-blue-900">Escala de Depressão Geriátrica (GDS-15)</h4>
                 <p className="text-sm text-blue-800">Rastreio de sintomas depressivos.</p>
               </div>
               <div className="space-y-2">
                 <p className="text-sm">Peça ao paciente para responder SIM ou NÃO baseado em como se sentiu na <strong>última semana</strong>.</p>
                 <ul className="list-disc list-inside space-y-1 text-sm">
                   <li>Pontuação 0-5: Normal</li>
                   <li>Pontuação 6-10: Depressão Leve</li>
                   <li>Pontuação 11-15: Depressão Grave</li>
                 </ul>
               </div>
            </>
          )}
          ...
          {activeTestId === 'meem_cognitive' && (
            <>
               <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                 <h4 className="font-bold text-blue-900">Mini Exame do Estado Mental (MEEM)</h4>
                 <p className="text-sm text-blue-800">Rastreio de função cognitiva (Brucki et al. 2003).</p>
               </div>
               <div className="space-y-2 text-sm">
                 <p>Avalia 5 áreas principais:</p>
                 <ol className="list-decimal list-inside space-y-1">
                   <li><strong>Orientação:</strong> Temporal e Espacial.</li>
                   <li><strong>Registro:</strong> Memória imediata (3 palavras).</li>
                   <li><strong>Atenção/Cálculo:</strong> Subtração de 7 ou soletrar inverso.</li>
                   <li><strong>Evocação:</strong> Memória tardia (3 palavras).</li>
                   <li><strong>Linguagem:</strong> Nomeação, repetição, comando, leitura, escrita, cópia.</li>
                 </ol>
                 <p className="mt-2 font-bold">Importante: Ajustar o ponto de corte pela escolaridade.</p>
               </div>
            </>
          )}
          ...
          {activeTestId === 'berg_balance' && (
             <div className="space-y-6 text-gray-700">
               <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                  <h4 className="font-bold text-blue-900">Escala de Equilíbrio de Berg</h4>
                  <p className="text-sm text-blue-800">Avaliação do equilíbrio estático e dinâmico (Katherine Berg).</p>
               </div>
               <div className="space-y-4">
                 <div>
                   <h5 className="font-bold text-gray-900 border-b pb-1 mb-2">Instruções de Pontuação (0-4)</h5>
                   <p className="text-sm text-gray-600 mb-2">
                     Geralmente, 4 é a capacidade de realizar a tarefa de forma independente e segura, e 0 é a incapacidade ou necessidade de assistência máxima.
                   </p>
                   <ul className="list-disc list-inside text-sm space-y-1">
                     <li><strong>0 a 20 pontos:</strong> Alto Risco de Quedas (Cadeirante).</li>
                     <li><strong>21 a 40 pontos:</strong> Médio Risco (Caminha com auxílio).</li>
                     <li><strong>41 a 56 pontos:</strong> Baixo Risco (Independente).</li>
                   </ul>
                 </div>
                 <div>
                   <h5 className="font-bold text-gray-900 mb-1">Tarefas:</h5>
                   <ul className="text-sm list-decimal list-inside grid grid-cols-1 sm:grid-cols-2 gap-1">
                      <li>Sentado para em pé</li>
                      <li>Em pé sem apoio</li>
                      <li>Sentado sem apoio</li>
                      <li>Em pé para sentado</li>
                      <li>Transferências</li>
                      <li>Em pé com olhos fechados</li>
                      <li>Em pé com pés juntos</li>
                      <li>Alcançar à frente</li>
                      <li>Pegar objeto do chão</li>
                      <li>Olhar para trás</li>
                      <li>Girar 360 graus</li>
                      <li>Pé no degrau (alternado)</li>
                      <li>Base Tandem (um pé frente outro)</li>
