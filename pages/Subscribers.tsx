...
export const Subscribers: React.FC = () => {
  ...
  const loadUsers = () => {
    // Filter logic can be added here if needed to only show subscribers
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-xl p-4 mb-8 flex items-center gap-4">
        ...
        <div>
           ...
           <p className="text-sm text-blue-700">3 novos alunos inscritos automaticamente hoje.</p>
        </div>
      </div>
